...
ALTER TABLE hms_customer CHANGE FIRST_NAME FIRST_NAME varchar(100) NOT NULL;
ALTER TABLE hms_customer CHANGE MIDDLE_NAME MIDDLE_NAME varchar(45) NOT NULL;
ALTER TABLE hms_customer CHANGE LAST_NAME LAST_NAME varchar(60) NOT NULL;
...
ALTER TABLE hms_employee CHANGE FIRST_NAME FIRST_NAME varchar(100)  NOT NULL;
ALTER TABLE hms_employee CHANGE MIDDLE_NAME MIDDLE_NAME varchar(45) NOT NULL;
ALTER TABLE hms_employee CHANGE LAST_NAME LAST_NAME varchar(60) NOT NULL;
