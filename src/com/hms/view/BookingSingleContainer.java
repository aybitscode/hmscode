...
public class BookingSingleContainer extends JPanel {
	...
	MainPage mpg;
  public BookingSingleContainer(MainPage mpg) {
	  this.mpg = mpg;
	    ...
	    leftSplitPanel.add(new SingleLeftPanel(mpg), BorderLayout.NORTH);
		...
		SingleRightPanel rightPanel = new SingleRightPanel(current_date);
	    ...
	    splitPane.setDividerLocation(MainPage.scrwidth/4);
	    splitPane.setPreferredSize(new Dimension(MainPage.scrwidth-MainPage.scrwidth/4, MainPage.scrheight-150));
