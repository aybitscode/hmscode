...
public class ViewAllFacilities extends JPanel {
	private JTable table;
	DefaultTableModel tableModel;
	JLabel transExcel;
	String filePath;
	private RoomFacilitiesController objCon;
	...
	MainPage mpg;
	public ViewAllFacilities(final MainPage mpg) {
		this.mpg = mpg;
...
//				lblCustomers.setForeground(new Color(50, 197, 210));
				...
				ConfigurationPanel.lblRoomFacilities.requestFocus(true);
			}
		});
		...
		lblCustomerHistory = new JLabel("All Room Facilities");
		...
		objCon = new RoomFacilitiesController (tableModel, table);
		objCon.retrieveAll(DatabaseConstants.TABLE_ROOM_FACILITES_COLS);
                ...
                try {
            		...
            		if (returnValue == JFileChooser.APPROVE_OPTION) {
            			 File file = jfc.getSelectedFile();
                          ...
                          ExcelExporter.fillData(table, filePath,"Room Facilities Details");
...
//     			}
		...
		comboSearch.getEditor().getEditorComponent().addKeyListener(new KeyAdapter() {
		    ...
		    public void keyReleased(KeyEvent event) {
		        if (event.getKeyChar() == KeyEvent.VK_ENTER) {
		            ...
		            {		            	
		            	objCon.retrieve(DatabaseConstants.TABLE_ROOM_FACILITES_NAME, ""+comboSearch.getSelectedItem());
		            }
		...
		sbm_customer_mobile = new SearchBoxModel(comboSearch, DatabaseConstants.ROOM_FACILITIES_NAME );
