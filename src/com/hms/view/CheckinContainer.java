...
public class CheckinContainer extends JPanel {
  ...
  public CheckinContainer(MainPage mpg) {
	  this.mpg = mpg;
	    ...
	    leftSplitPanel.add(new CheckInEntry(mpg), BorderLayout.NORTH);
		...
		CheckinRightPanel rightPanel = new CheckinRightPanel(current_date);
		...
		lblCheckin = new JLabel("                        CHECKIN DETAILS");
