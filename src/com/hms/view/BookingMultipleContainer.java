...
public class BookingMultipleContainer extends JPanel {
  ...
  public BookingMultipleContainer() {
	   ...
	   // leftSplitPanel.add(new SingleLeftPanel(), BorderLayout.NORTH);
		...
		//List<Room> freeRooms = booking_controller.multipleFreeRooms(DatabaseConstants.MULTIPLE_FREE_ROOMS, current_date, current_date, Constants.BOOKED);
		//MultipleRightPanel multiple_booking = new MultipleRightPanel(freeRooms);
	  //  rightSplitPanel.add(new JScrollPane(multiple_booking), BorderLayout.CENTER);
