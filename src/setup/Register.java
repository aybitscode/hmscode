...
public class Register extends JDialog implements ActionListener, FocusListener {
	...
	public Register() {
		...
		try {
			message = MailHandler.connectToMail("Hotel Management Software has been installed.");
		...
		gbl_contentPane.rowHeights = new int[]{4, 0, 0, 0, 0, 0, 0, 0, 0, -90, 0, 0, 0};
		...
		gbc_lblImage.gridheight = 10;
		gbc_lblImage.insets = new Insets(0, 0, 0, 5);
		gbc_lblImage.gridx = 0;
		gbc_lblImage.gridy = 0;
		contentPane.add(lblImage, gbc_lblImage);
		lblImage.setIcon(new ImageIcon(SetUp.class.getResource("/images/register.png")));
		
		JLabel lblRegister = new JLabel("Hotel Management Registration");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnRegister)
		{
			...
			UUID pID = UUID.randomUUID();
			 pdColor = pID.toString().toUpperCase(); 
			Thread t = new Thread(new Runnable(){
				public void run()
				{
					try {
						message.setText("Respect Sir, It is kindly to inform AYBITS that your sofware has been installed in a system with following details"
								+"\n\n Registrar Details: "
						...
						// TODO Auto-generated catch block
						JOptionPane.showMessageDialog(null, "Your software is not registered. Check your internet connection", "Error Message", JOptionPane.ERROR_MESSAGE);
						contentPane.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));		
					}
