...
import com.hms.controller.BookingCardTransactionController;
...
public class BookingCardTransactions extends JPanel implements ActionListener{
	/**
	 * 
	 */
	...
	BookingCardTransactionController obj_bet;
	 ...
	 */
	public BookingCardTransactions() {
		...
		obj_bet = new BookingCardTransactionController(tableModel, table);
		...
		combo_search.getEditor().getEditorComponent().addKeyListener(new KeyAdapter() {
		    ...
		    public void keyReleased(KeyEvent event) {
		        if (event.getKeyChar() == KeyEvent.VK_ENTER) {
		            ...
		            {
		            	obj_bet.retrieveAllTransactions(DatabaseConstants.ALL_BOOKING_PAYMENTMODE, Constants.CARD);
		            }
		            else
		            {		            	
		            	obj_bet.retrieveTransaction(DatabaseConstants.ALL_BOOKING_ID, ""+combo_search.getSelectedItem());
		            }
		...
		sbm_consignCom = new SearchBoxModel(combo_search, DatabaseConstants.ALL_BOOKING_PAYMENTMODE, Constants.CARD);
