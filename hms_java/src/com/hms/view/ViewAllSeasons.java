...
public class ViewAllSeasons extends JPanel {
	private JTable table;
	DefaultTableModel tableModel;
	JLabel transExcel;
	String filePath;
	private SeasonController objCon;
	...
	MainPage mpg;
	public ViewAllSeasons(final MainPage mpg) {
		this.mpg = mpg;
...
//				lblCustomers.setForeground(new Color(50, 197, 210));
				...
				ConfigurationPanel.lblSeasonDetails.requestFocus(true);
			}
		});
		...
		lblCustomerHistory = new JLabel("All Seasons");
		...
		objCon = new SeasonController(tableModel, table);
		objCon.retrieveAll(DatabaseConstants.TABLE_SEASON_COLS);
		...
		comboSearch.getEditor().getEditorComponent().addKeyListener(new KeyAdapter() {
		    ...
		    public void keyReleased(KeyEvent event) {
		        if (event.getKeyChar() == KeyEvent.VK_ENTER) {
		            ...
		            {		            	
		            	objCon.retrieve(DatabaseConstants.TABLE_SEASON_NAME, ""+comboSearch.getSelectedItem());
		            }
