...
import com.hms.controller.BookedTransactionController;
...
public class BookedTransactions extends JPanel implements ActionListener{
	/**
	 * 
	 */
	...
	BookedTransactionController obj_btc;
	...
	public BookedTransactions() {
		...
		obj_btc = new BookedTransactionController(tableModel, table);
		...
		combo_search.getEditor().getEditorComponent().addKeyListener(new KeyAdapter() {
		    ...
		    public void keyReleased(KeyEvent event) {
		        if (event.getKeyChar() == KeyEvent.VK_ENTER) {
		            ...
		            {
		            	obj_btc.retrieveAllBookingsStatus(DatabaseConstants.ALL_BOOKING_STATUS, Constants.BOOKED);
		            }
		            else
		            {		            	
		            	obj_btc.retrieveBooking(DatabaseConstants.ALL_BOOKING_ID, ""+combo_search.getSelectedItem());
		            }
		...
		sbm_consignCom = new SearchBoxModel(combo_search, DatabaseConstants.SELECT_CANCELLED_BOOKING, Constants.BOOKED);
