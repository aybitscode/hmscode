...
public class CheckoutContainer extends JPanel {
  ...
  public CheckoutContainer(MainPage mpg) {
	  this.mpg = mpg;
	    ...
	    leftSplitPanel.add(new BookingCheckout(mpg), BorderLayout.NORTH);
		...
		CheckoutRightPanel rightPanel = new CheckoutRightPanel(current_date);
		...
		lblCheckin = new JLabel("                        CHECKOUT DETAILS");
