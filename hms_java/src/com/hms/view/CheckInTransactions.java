...
import com.hms.services.CheckInTransactionService;
...
public class CheckInTransactions extends JPanel {
	/**
	 * 
	 */
	...
	CheckInTransactionService checkin_transaction_service;
	...
	public CheckInTransactions() {
		...
		lblBookingTransactions = new JLabel("CheckIn Transactions");
		...
		checkin_transaction_service = new CheckInTransactionService(tableModel, table);
		checkin_transaction_service.retrieveBookings();
		table.setFont(new Font(SFont.ctFType,SFont.ctfProp, SFont.ctSize));
		...
		transExcel.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e)
			{
                ...
                try {
     			...
     			{
                    ExcelExporter.fillData(table, filePath,"CheckIn Transactions");
