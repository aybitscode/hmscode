...
import com.hms.controller.BookingCancelTransactionController;
...
public class BookingCancelTransactions extends JPanel implements ActionListener{
	/**
	 * 
	 */
	...
	BookingCancelTransactionController btc;
	 ...
	 */
	public BookingCancelTransactions() {
		...
		lblRows.setFont(new Font(SFont.ctFType,SFont.ctfProp, SFont.ctSize));
		...
		btc = new BookingCancelTransactionController(tableModel, table);
		...
		gbc_lblBookingTransactions.gridx = 1;
		...
		combo_search.getEditor().getEditorComponent().addKeyListener(new KeyAdapter() {
		    ...
		    public void keyReleased(KeyEvent event) {
		        if (event.getKeyChar() == KeyEvent.VK_ENTER) {
		            ...
		            {
		            	btc.retrieveAllBookingsStatus(DatabaseConstants.ALL_BOOKING_STATUS, Constants.CANCEL);
		            }
		            else
		            {		            	
		            	btc.retrieveBooking(DatabaseConstants.ALL_BOOKING_ID, ""+combo_search.getSelectedItem());
		            }
		...
		sbm_consignCom = new SearchBoxModel(combo_search, DatabaseConstants.SELECT_CANCELLED_BOOKING, Constants.CANCEL);
		...
		gbc_lblBookingTransactions1.gridx = 4;
