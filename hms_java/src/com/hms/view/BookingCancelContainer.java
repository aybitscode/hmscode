...
public class BookingCancelContainer extends JPanel {

	JPanel leftSplitPanel;
	public static JPanel rightSplitPanel;
	...
	public static BookingCancel objBookingCancel;
  public BookingCancelContainer(MainPage mpg) {
	  this.mpg = mpg;
	    ...
	    objBookingCancel = new BookingCancel(mpg);
	    leftSplitPanel.add(objBookingCancel, BorderLayout.NORTH);
		...
		BookingCancelRightPanel rightPanel = new BookingCancelRightPanel(current_date);
		...
		lblCheckin = new JLabel("                       CANCEL BOOKINGS");
		GridBagConstraints gbc_lblCheckin = new GridBagConstraints();
		gbc_lblCheckin.gridwidth = 2;
		gbc_lblCheckin.insets = new Insets(0, 0, 0, 0);
		gbc_lblCheckin.gridx = 0;
		gbc_lblCheckin.gridy = 0;
		add(lblCheckin, gbc_lblCheckin);
		lblCheckin.setForeground(new Color(50, 197, 210));
		...
		gbc_lblCheckedIn.insets = new Insets(0, 0, 0, 0);
	    ...
	    splitPane.setPreferredSize(new Dimension(MainPage.scrwidth-200, MainPage.scrheight-150));
	...
	public void setcFont()
	{
		...
		lblCheckin.setFont(new Font(SFont.ctFType,SFont.ctfProp,SFont.ctSize));
	}
