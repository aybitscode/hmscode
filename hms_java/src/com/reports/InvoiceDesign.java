...
//	TextColumnBuilder<String> taxColumn;
//	Double tax;
...
//		   for (Item number : DealerPayments.items) {
//
//				 taxColumn = col.column("Tax", exp.text(""+number.getTax()))
//					.setFixedColumns(3);
//				 tax=number.getTax();
//			  System.out.println("DESCRIPTIOn READDDDDDDDDDDDDDD"+number.getTax());
//			    } 
//		//TextColumnBuilder<String> taxColumn = col.column("Tax", exp.text(""+data.getInvoice().getTax()))
//			//.setFixedColumns(3);
...
//		//vat = price * tax
//		TextColumnBuilder<BigDecimal> vatColumn = priceColumn.multiply(tax)
//			.setTitle("VAT")
//			.setDataType(Templates.currencyType);
//		//total = price + vat
...
//			//band components
//			.title(
//				Templates.createTitleComponent("\n"+"Khivraj Motors"+"\n"+"Authorised Service Centre"+"\n\n\n\n"+"Invoice No.: " + DealerPayments.uid+"\n"+"Date: "+DealerPayments.fdate),
