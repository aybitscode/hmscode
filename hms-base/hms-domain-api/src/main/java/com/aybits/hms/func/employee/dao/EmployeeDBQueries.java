...
public class EmployeeDBQueries {
    ...
    static final String ADD_EMPLOYEE = "insert into hms_employee(employee_id,corporate_id,emp_full_name,email,mobile," +
            "home_address,identification_param_id, payment_param,hms_hotel_id," +
            "employee_status,date_created) "+
            "values(?,?,?,?,?,?,?,?,?,?,?)";
    static final String UPDATE_EMPLOYEE = "update hms_employee set emp_full_name = ?, home_address = ?, identification_param_id, payment_param," +
